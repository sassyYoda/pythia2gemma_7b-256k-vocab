...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help="Target tokenizer path (default: google/gemma-7b)"
    )
    parser.add_argument(
        "-o", "--output-dir",
        type=str,
        default="./data/pythia2gemma-7b",
        help="Output directory for alignment matrices (default: ./data/pythia2gemma-7b)"
    )
    parser.add_argument(
        "--seed",
        type=int,
